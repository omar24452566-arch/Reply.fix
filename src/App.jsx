...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .eyebrow-dot {
    width: 5px; height: 5px; border-radius: 50%; background: #ea580c;
    box-shadow: 0 0 6px rgba(234,88,12,0.8);
    animation: logopin 2s ease-in-out infinite;
  }
  .h1 {
  ...
  .sub {
    font-size: 15.5px; color: #5a5550; font-weight: 300; line-height: 1.65;
  ...
  .ba-top {
    padding: 18px 22px; background: rgba(255,255,255,0.012);
    border-bottom: 1px solid #1a1816;
  }
  .ba-bottom {
    display: grid; grid-template-columns: 1fr 1fr;
  }
  @media(max-width:520px){ .ba-bottom { grid-template-columns: 1fr; } }
  .ba-side { padding: 18px 22px; }
  .ba-l { background: rgba(127,29,29,0.07); border-right: 1px solid #1a1816; }
  .ba-r { background: rgba(6,78,59,0.09); }
  .ba-lbl {
    font-size: 10px; font-weight: 600; letter-spacing: 0.12em;
    text-transform: uppercase; margin-bottom: 10px;
    display: flex; align-items: center; gap: 6px;
  }
  .lbl-muted { color: #3a3834; }
  .lbl-red { color: #ef4444; }
  .lbl-grn { color: #10b981; }
  .dot { width: 5px; height: 5px; border-radius: 50%; }
  .dot-m { background: #3a3834; }
  .dot-r { background: #ef4444; }
  .dot-g { background: #10b981; }
  .ba-orig {
    font-size: 13px; line-height: 1.6; color: #5a5550; font-style: italic;
  }
  .ba-bad {
    font-size: 13px; line-height: 1.6; color: #7c2020;
  }
  .ba-good {
    font-size: 13px; line-height: 1.65; color: #a7f3d0;
  }
    ...
    <div className="dr">
      ...
      <div className="wrap">
        ...
        <section className="hero">
          <div className="eyebrow"><div className="eyebrow-dot"/>Live AI · Instant replies</div>
          <h1 className="h1">You're one reply away from <em>losing this customer.</em></h1>
          <p className="sub">Paste the message. Get the exact reply that keeps them.</p>
          <div className="ba">
            <div className="ba-top">
              <div className="ba-lbl lbl-muted"><div className="dot dot-m"/>What the customer sent</div>
              <div className="ba-orig">{EX.angry}</div>
            </div>
            <div className="ba-bottom">
              <div className="ba-side ba-l">
                <div className="ba-lbl lbl-red"><div className="dot dot-r"/>Typical reply</div>
              ...
              <div className="ba-side ba-r">
                ...
                <div className="ba-good">{EX.good}</div>
              </div>
            </div>
          </div>
        </section>
